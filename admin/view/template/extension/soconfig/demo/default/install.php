<?php
	...
	if($number_store > 1){
		...
		$quickstart_sql = DIR_TEMPLATE.'extension/soconfig/demo/'.$install_layout.'/quickstart.sql';
		...
		$settings_sql = DIR_TEMPLATE.'extension/soconfig/demo/'.$install_layout.'/themes.sql';
