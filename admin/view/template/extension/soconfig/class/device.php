	...
	public function __construct($registry) {
		...
		if(!$this->is_admin()){
			if($this->session->data['device']=="mobile" && !empty($template_mobile))	{
				if (!defined('DIR_TEMPLATE'))  define('DIR_TEMPLATE', DIR_APPLICATION.'view/theme_mobile/');
				if (!defined('URL_TEMPLATE'))  define('URL_TEMPLATE', 'catalog/view/theme_mobile/');
			}else {
				if (!defined('DIR_TEMPLATE')) define('DIR_TEMPLATE', DIR_APPLICATION.'view/theme/');
			...
			if (!defined('URL_TEMPLATE_MOBILE'))  define('URL_TEMPLATE_MOBILE', DIR_CATALOG.'view/theme_mobile/');
		}
